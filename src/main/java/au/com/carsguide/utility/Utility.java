...
import au.com.carsguide.drivermanager.ManageBrowser;
...
//*************************** Select Class Methods ***************************************//
    ...
    public void selectByContainsTextFromDropDown(WebElement findBy, String text) {
        List<WebElement> allOptions = new Select(findBy).getOptions();
        for (WebElement options : allOptions) {
            if (options.getText().contains(text)) {
                options.click();
            }
...
//***************************** Is Display Methods **********************************************//
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/com/cvlibrary/screenshots/" + screenshotName + dateName + ".png";
